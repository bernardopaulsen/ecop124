...
@
            ...
            Nos gráficos acima podemos ver que a única ordem de lags que gera resíduos que são ruído branco é a ordem 24, então realizamos o teste com essa ordem e visualizamos o sumário do teste.
...
<<>>=
adf <- ur.df(na.omit(data1$Diff), lags=23)
summary(adf)
@
